...
const PodcastCard = ({ items }) => {
  const dispatch = useDispatch(isLoggedIn);
      ...
      >
        ...
        <div className="mt-2">
          <Link
            ...
            className="bg-green-900 text-white px-4 py-2 rounded mt-2 flex items-center justify-center hover:bg-green-300 transition-all duration-300"
            onClick={handlePlay}
          >
            Play Now
          </Link>
